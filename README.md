...
-->
#### fork自https://github.com/xdlumia/vue3-video-play
...
```bash
npm i vue3-video-play-fork --save
```

yarn 安装：

```bash
yarn add vue3-video-play-fork --save
```
...
import vue3videoPlay from "vue3-video-play-fork"; // 引入组件
import "vue3-video-play-fork/dist/style.css"; // 引入css
...
```js
// require style
import "vue3-video-play-fork/dist/style.css";
import { videoPlay } from "vue3-video-play-fork";
export default {
  components: {
    videoPlay,
  },
...
:::demo `vue3-video-play-fork` 支持原生`video`所有事件。
...
:::demo `vue3-video-play-fork` 支持 m3u8(hls)播放
...
vue3-video-play-fork 支持 video 原生所有 Attributes [video 原生属性](https://segmentfault.com/a/1190000008053507) 使用方式和 props 属性使用一致
...
vue3-video-play-fork 支持 video 原生所有事件 [video 默认事件](https://segmentfault.com/a/1190000008053507)
...
[vue3-video-play-fork](https://github.com/xdlumia/vue3-video-play-fork)
